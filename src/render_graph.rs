...
// ---------------------------------------------------------------------------
// Compile-time shader registry — generated by build.rs
// ---------------------------------------------------------------------------

// `embedded_shader(name)` is auto-generated from the contents of `shaders/`.
// Add a shader by dropping `<name>.vert` + `<name>.frag` under `shaders/`
// and referencing `shader = "<name>"` in `config/graph.toml`. No edits to
